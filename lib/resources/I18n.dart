...
class I18n {
  static final _localizations = {
    "en": {
      ...
      "tracks_file_validation_error": "Either the track already exists or it is not valid",
      ...
      "tracks_delete_selection": "Delete selection",
      "tracks_select_move_destination": "Select destination",
      "tracks_move_forbidden": "The folder can't be moved here if you intend to preserve the Space-Time continuum",
      "tracks_open_maps_error": "Error while opening the location",
      ...
      "info_altitude_slope": "Avg Pos. Slope",
    ...
    "es": {
      ...
      "tracks_file_validation_error": "La ruta ya existe o ha habido problemas de validación",
      ...
      "tracks_delete_selection": "Eliminar selección",
      "tracks_select_move_destination": "Selecciona destino",
      "tracks_move_forbidden": "El directorio no se puede mover aquí si pretendes conservar el continuo espacio-tempo",
      "tracks_open_maps_error": "Error abriendo la ubicación",
      ...
      "info_altitude_min": "Min",
      "info_altitude_top": "Top",
      "info_altitude_gain": "Acumulado",
      "info_chart_altitude": "Altitud",
      "info_chart_distance": "Distancia",
      "info_altitude_slope": "Pte. media pos.",
    ...
    "gl": {
      ...
      "common_save": "Gardar",
      "common_save_all": "Gardar todo",
      "common_name": "Nome",
      "common_rename": "Cambiar nome",
      "common_close": "Pechar",
      "common_app_name": "Vieiros",
      "common_share": "Compartir",
      "common_move": "Mover",
      ...
      "tracks_delete_selection": "Eliminar selección",
      "tracks_select_move_destination": "Elixe destino",
      "tracks_move_forbidden": "O cartafol non se pode mover aquí se pretendes preserva-lo continuo espacio-tempo",
      "tracks_open_maps_error": "Erro abrindo a localización",
      "map_waypoint": "Nome punto de ruta",
      "map_notification_title": "Gravando ruta...",
      "map_channel_name_location": "Servicio localización en segundo plano",
